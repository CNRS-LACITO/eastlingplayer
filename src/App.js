			        ...
			        if(result==null || (result.annotations["TEXT"] == undefined && result.annotations["WORDLIST"] == undefined )){
			        	...
			        	this.setState({
			        		...
			        		displayOptions:{
					        	...
					        	wordTranscriptions : (document.location.search.indexOf("optionWordTranscriptions") > 0) ? optionWordTranscriptions.split('+') : [],
					        	wordTranslations : (document.location.search.indexOf("optionWordTranslations") > 0) ? optionWordTranslations.split('+') : [],
